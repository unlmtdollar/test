...
async function connectWallet() {
    try {
        ...
        if (typeof window.ethereum !== 'undefined') {
            // ✅ FIXED: Proper ethers provider initialization
...
async function refreshContractInfo() {
    ...
    try {
        ...
        document.getElementById('contractAddress').textContent = CONTRACT_ADDRESS.slice(0, 8) + '...' + CONTRACT_ADDRESS.slice(-6);
        ...
        document.getElementById('totalTokensSold').textContent = ethers.utils.formatUnits(totalTokensSold, 18) + ' NUUR';
        document.getElementById('totalSDAReceived').textContent = ethers.utils.formatEther(totalSDAReceived) + ' SDA';
        document.getElementById('sdaBalance').textContent = ethers.utils.formatEther(sdaBalance) + ' SDA';
        document.getElementById('nuurBalance').textContent = ethers.utils.formatUnits(nuurBalance, 18) + ' NUUR';
